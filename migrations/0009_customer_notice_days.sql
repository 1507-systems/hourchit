...
-- The example tenant's SOW section 3.6, rate adjustment notice, is a per-SOW
-- field -- blank in the template precisely so it gets filled in per engagement
-- -- and one client's SOW names sixty days. Holding one number on the
