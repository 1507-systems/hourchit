 ...
 * single number would silently destroy a term like the example tenant's SOW
 * 3.3 -- four hours for an event beginning Saturday or Sunday, none Monday to
 * Friday --
 ...
 * clause being implemented -- the example tenant's MSA section 3.3 -- governs
 * a rate update applied across the whole client base: one change, every client,
 * each under their own separately negotiated notice period. Satisfying
