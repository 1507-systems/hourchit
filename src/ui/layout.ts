...
header{display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:.4rem 1rem;padding:.8rem 1rem;
  border-bottom:1px solid var(--rule);background:var(--paper)}
header .biz{font-family:var(--mono);font-weight:600;letter-spacing:.02em}
header nav{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:.25rem .75rem;margin-left:auto}
...
.dashboard .card{padding-top:.65rem}
.dashboard .card h2{margin-top:.25rem}
.module-controls{display:flex;justify-content:flex-end;gap:.35rem;margin:0 0 .35rem}
.module-controls button{width:auto;min-width:2.4rem;padding:.3rem .55rem;font-size:.8rem}
.module-controls button:disabled{opacity:.4;cursor:not-allowed}
.dashboard-module-hidden{border-style:dashed}
